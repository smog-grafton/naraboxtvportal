        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('approve_creator_submission')
                    ...
                    ->visible(fn (Movie $record) => in_array($record->editorial_status, ['submitted_for_review', 'under_review'], true))
                    ->action(fn (Movie $record) => app(CreatorContentWorkflowService::class)
                ...
                Tables\Actions\Action::make('request_creator_changes')
                    ...
                    ->action(fn (Movie $record, array $data) => app(CreatorContentWorkflowService::class)->moderate(
                        $record,
                        auth()->user(),
                        'changes_requested',
                ...
                Tables\Actions\Action::make('approve_monetization')
                    ...
                    ->visible(fn (Movie $record) => $record->monetization_status === 'pending_review' && $record->monetizationSetting)
                ...
                Tables\Actions\Action::make('reassign_creator_owner')
                    ...
                    ->action(fn (Movie $record, array $data) => app(CreatorContentWorkflowService::class)->reassignOwner(
                        $record,
                        auth()->user(),
                        $data['owner_type'],
