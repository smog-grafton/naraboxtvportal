 ...
 * source, in order:
 *
 *   1. Contabo API usage/quota (if an object_storage_id is configured for
 *      the target and Contabo API credentials are present).
...
class StorageUsageService
{
    ...
    private function store(string $targetKey, int $usedBytes, string $source): void
    {
        ...
        // A fresh authoritative snapshot supersedes the incremental delta.
