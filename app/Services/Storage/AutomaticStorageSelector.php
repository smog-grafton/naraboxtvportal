 ...
 * Manual/explicit selection is still validated against the soft-cap and
 * requires a privileged override to proceed past it.
 */
class AutomaticStorageSelector
{
    ...
    public function resolveAutomatic(int $expectedBytes): array
    {
        ...
        // Highest priority first (nb-nbx > nbx by default while nbx is
        // near its soft limit), then most remaining headroom.
