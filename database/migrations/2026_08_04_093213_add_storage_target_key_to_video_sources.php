...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('video_sources', function (Blueprint $table) {
            $table->string('storage_target_key', 64)->nullable()->after('storage_bucket');
        });

        Schema::table('download_sources', function (Blueprint $table) {
            $table->string('storage_target_key', 64)->nullable()->after('file_path');
        });
